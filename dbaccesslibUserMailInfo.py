...
import pymongo
uri = "mongodb://6108b574-0ee0-4-231-b9ee:SAInTs4eIMxuAy2WxJtKCTf9K3bpTvpyMZsiKgrNaEqpbHPStDCV5xBC4X1EiDjhPiFBg44loIONqwVwq3PiZA==@6108b574-0ee0-4-231-b9ee.documents.azure.com:10255/?ssl=true&replicaSet=globaldb"
...
def addEntry(jsonData,tags,autoThrashed):
    ...
    if( not autoThrashed and len(tags) >= 3):
        ...
        mydb.mltable.insert({"code":jsonData["code"],"tags": tags,"status":"Thrash","user_id":1,"otherdbref":newDbref})#Test code to be removed
        end_date = scan_date
